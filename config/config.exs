...
config :kanta_test, KantaTestWeb.Endpoint,
  url: [host: "kanta.curiosum.dev"],
  render_errors: [
    formats: [html: KantaTestWeb.ErrorHTML, json: KantaTestWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: KantaTest.PubSub,
  live_view: [signing_salt: "YnrfM4EX"]
...
config :kanta_test, KantaTest.Mailer, adapter: Swoosh.Adapters.Local
